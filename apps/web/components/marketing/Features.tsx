...
export function Features() {
  return (
    <section className="section-padding bg-cream" id="features">
      <div className="container-narrow">
        <div className="text-center mb-16">
          <h2 className="font-serif font-bold text-3xl sm:text-4xl lg:text-5xl text-slate-blue mb-4">
            Everything Your Business <span className="text-forest-green">Needs</span>
          </h2>
          <p className="text-lg text-slate-blue-500 max-w-2xl mx-auto">
            From generation to management, RapidBooth handles every aspect of
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {FEATURES.map((feature) => (
            ...
            >
              <div className="w-12 h-12 rounded-xl bg-forest-green/10 flex items-center justify-center text-forest-green mb-5 group-hover:bg-forest-green group-hover:text-white transition-colors duration-300">
                <FeatureIcon icon={feature.icon} />
              </div>
              <h3 className="font-serif font-bold text-xl text-slate-blue mb-3">
                {feature.title}
              </h3>
