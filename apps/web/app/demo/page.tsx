        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          ...
          <div className="space-y-4">
            <button
              ...
              disabled={isLoading}
              className="inline-flex items-center justify-center px-8 py-4 rounded-lg bg-harvest-gold text-forest-green-900 font-semibold text-lg shadow-md hover:shadow-lg hover:bg-harvest-gold-600 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
                <>
